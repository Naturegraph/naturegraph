 ...
 * Utilise FeatureCard du DS (variant boxed + center).
 */
...
export function Storytelling() {
  ...
  return (
    <section className="w-full flex justify-center" data-name="Section 6 : Storytelling">
      <div className="w-full max-w-[1728px] bg-[var(--color-bg-tertiary)] px-6 md:px-10 lg:px-32 py-20 lg:py-32">
        ...
        {/* 3 traits — cartes du DS (boxed + center + icon highlight-solid) */}
