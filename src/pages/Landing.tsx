    ...
    <section id="discover" className="py-16 lg:py-24 bg-[var(--color-bg-secondary)]">
      <div className="max-w-[1280px] mx-auto px-5 lg:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {cards.map((card, i) => (
            <div key={i} className="bg-white rounded-2xl p-6 lg:p-8 border border-gray-100">
      ...
      <div className="max-w-[1280px] mx-auto px-5 lg:px-10">
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-gray-500 max-w-xl mx-auto">
            Publie tes observations, ajoute des photos et decouvre ce que tu as a offrir. Chaque
            aventure devient un souvenir partage avec la communaute.
          </p>
        </div>
      ...
      <div className="flex flex-col lg:flex-row min-h-[400px] lg:min-h-[500px]">
        ...
        <div className="lg:w-1/2 bg-[var(--color-text-primary)] px-5 lg:px-16 py-16 lg:py-24 flex flex-col justify-center">
          ...
          <p className="text-sm text-white/60 leading-relaxed mb-8 max-w-md">
            Imagine que tes pas sont les guides, que ta feuille de route est faite de sentiers, de
            chants d'oiseaux et de rencontres inattendues. Naturegraph t'accompagne pour ne plus
            jamais perdre le fil de tes explorations.
          </p>
          <Link
            to="/signup"
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-sm text-gray-500 leading-relaxed mb-4">
              La science naturaliste permet de comprendre. Naturegraph permet de documenter tes
              decouvertes et de les valoriser dans un cadre collaboratif et pedagogique. En
              combinant technologie et intelligence collective, Naturegraph veut transformer chaque
              observation en une contribution utile.
            </p>
            <p className="text-sm text-gray-500 leading-relaxed">
              Que tu sois debutant curieux, observateur aguerri ou scientifique passionne, chaque
              donnee que tu ajoutes enrichit notre comprehension collective de la biodiversite.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-sm text-gray-500 leading-relaxed mb-6 max-w-md">
              Un espace unique pour echanger sur tes sorties nature, poser tes questions, donner ton
              avis sur les evolutions de l'application et rencontrer d'autres passionnes.
            </p>
            ...
            <div className="space-y-3">
              <div className="bg-[#2F3136] rounded-lg p-3">
                ...
                <p className="text-sm text-gray-300">
                  Bienvenue dans la communaute Naturegraph ! N'hesite pas a te presenter.
                </p>
              </div>
              <div className="bg-[#2F3136] rounded-lg p-3">
                <p className="text-xs text-gray-400 mb-1"># identifications</p>
                <p className="text-sm text-gray-300">
                  Quelqu'un peut m'aider a identifier cet oiseau ? Photo prise ce matin.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-[1280px] mx-auto px-5 lg:px-10 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              Naturegraph est un projet en cours de developpement. Rejoins-nous pour observer,
              documenter et partager la biodiversite.
            </p>
          </div>

          {/* Produit */}
          <div>
            <h4 className="text-sm font-semibold text-[var(--color-text-primary)] mb-4">Produit</h4>
          ...
          <div>
            <div className="bg-[var(--color-primary)] rounded-2xl p-6">
              ...
              <p className="text-xs text-white/60 mb-4">Decouvre les futures mises a jour.</p>
              <Link
                to="/signup"
