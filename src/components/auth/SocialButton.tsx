...
export function SocialButton({ provider, onClick, disabled }: SocialButtonProps) {
  ...
  return (
    <button
      ...
      className="flex-1 flex items-center justify-center h-14 rounded-xl border border-[var(--color-border)] bg-white hover:bg-[var(--color-action-light)] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
    >
