...
export function SocialButton({ provider, onClick, disabled }: SocialButtonProps) {
  ...
  return (
    <button
      ...
      className="btn-press btn-press-secondary flex-1 flex items-center justify-center h-14 rounded-xl bg-transparent transition-all disabled:opacity-50 disabled:cursor-not-allowed"
    >
