      ...
      >
        ...
        <div className="shrink-0 flex items-center justify-between gap-3 px-5 h-16 border-b border-border">
          ...
          <button
            ...
            className="size-9 rounded-full bg-muted hover:bg-muted/70 flex items-center justify-center text-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          >
