...
export function postFeedItemToMockPost(item: PostFeedItem, _index = 0): MockPost {
  ...
  return {
    ...
    // NG-055 : phénomène des posts Instant Nature, lu depuis la colonne dédiée
    // posts.phenomenon (fallback tags[0] pour les anciens posts créés via le
    // workaround tags, avant le fix 2026-08). Affiché dans la rangée méta
