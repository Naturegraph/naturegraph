/**
 * SpeciesSearchBar : barre de recherche d'espèces (autocomplétion + filtres par
 * groupe taxonomique + import de carnets existants).
 *
 * Extraite d'EncounterStep2.tsx (Lot 4) : c'était un sous-composant inline de ~670
 * lignes qui gonflait artificiellement l'étape 2. Déplacement VERBATIM (aucun
 * changement de comportement), avec ses helpers exclusifs SpeciesCategoryIcon et
 * CLASS_TO_GROUP.
 */

import { useState, useId, useEffect, useMemo, useRef } from 'react'
import { Search, Filter, X, Check, Loader2, BookOpen } from 'lucide-react'
...
import { groupConfig, TAXONOMIC_FILTERS } from './encounterSpeciesLogic'
...
// Mapping iNat class -> taxonomic_group (préserve la cohérence UI existante).
