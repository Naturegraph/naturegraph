-- ============================================================
-- V1.1.0 prep : search_taxonomy() v2 avec availability + inat_id
-- Date : 2026-05-26
-- Appliquee sur prod via MCP, archive ici pour traceabilite
-- ============================================================
-- Ajout des colonnes available_in_fr, available_in_ca, inaturalist_id
-- au resultat pour permettre au front d afficher :
--   - les drapeaux FR/CA a cote de chaque resultat
--   - le lien vers la fiche iNat
-- ============================================================

DROP FUNCTION IF EXISTS public.search_taxonomy(TEXT, TEXT, TEXT[], TEXT, INTEGER);
...
RETURNS TABLE (
  ...
  available_in_fr BOOLEAN, available_in_ca BOOLEAN,
